...
for(var i = 1; i<finances.length; i++){
    total_change += finances[i][1] - finances[i-1][1];
}

var average_change = total_change / finances.length;
average_change = Math.round(total_change / (finances.length - 1) * 100) / 100;
